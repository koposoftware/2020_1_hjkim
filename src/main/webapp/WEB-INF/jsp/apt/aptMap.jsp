	...
	<script>
			...
			$.ajax({
				...
				success : function(data) {
					var content = '<div class="wrap">' + 
									...
									data.aptDetailVO.kaptAddr + 
									'</div>' + 
									'                <div class="ellipsis"> <b>(도로명)</b><br>' + 
									data.aptDetailVO.doroJuso + 
									'</div>' + 
									'                <div class="jibun ellipsis">| 동수 | ' + 
									data.aptDetailVO.kaptDongCnt + 
									' |세대수 | ' + data.aptDetailVO.kaptDaCnt + 
									'</div>' + 
									'            </div>' + 
									'        </div>' + 
									'    </div>' + 
		...
		function displayList(data){
			if(data == 'clear'){
				...
				let str = '';
				str += '<div class="apt-list-one" onclick="location.href=' + "'${ pageContext.request.contextPath }/apt/detail/"+ data.aptBasicVO.kaptCode +'\'">'
